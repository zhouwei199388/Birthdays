...
public class LunarCalendar {
    ...
    public static String lunarToSolarString(int year, int month, int monthDay,
        ...
        int[] solarInfo = lunarToSolar(year, month, monthDay, isLeapMonth);
        stringBuffer.append(solarInfo[0]);
        stringBuffer.append("-");
        stringBuffer.append(solarInfo[1]);
        stringBuffer.append("-");
        stringBuffer.append(solarInfo[2]);
     ...
     * @param year     传入的年份
     * @param month    传入的月份
     * @param monthDay 传入的日期
     * @return 字符串日期
     */
    public static final String solarToLunarString(int year, int month, int monthDay) {
        int[] data = solarToLunar(year, month, monthDay);
...
//        lunarDate.append("-");
    ...
    public static String lunarToSolar(long time) {
        Calendar calendar = new GregorianCalendar();
        calendar.setTimeInMillis(time);
        String data = lunarToSolarString(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH) + 1, calendar.get(Calendar.DAY_OF_MONTH), true);
        return data;
    }
     ...
     * @return
     */
    public static String getLunarData(long time) {
        StringBuffer data = new StringBuffer();
        Calendar calendar = new GregorianCalendar();
        calendar.setTimeInMillis(time);
        data.append(calendar.get(Calendar.YEAR));
        data.append("年");
        data.append(getLunarMonthName(calendar.get(Calendar.MONTH) + 1));
        data.append("月");
        data.append(getLunarDayName(calendar.get(Calendar.DAY_OF_MONTH)));
